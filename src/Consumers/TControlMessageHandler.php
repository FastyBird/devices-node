			...
			if ($row->offsetExists('type')) {
				...
				switch ($row->offsetGet('type')) {
					case DevicesNode\Constants::DATA_TYPE_NUMBER:
						if ($isForDevice) {
							$toUpdateRow['entity'] = Entities\Devices\Configuration\NumberRow::class;

						} else {
							$toUpdateRow['entity'] = Entities\Channels\Configuration\NumberRow::class;
						}
					...
					case DevicesNode\Constants::DATA_TYPE_TEXT:
						if ($isForDevice) {
							$toUpdateRow['entity'] = Entities\Devices\Configuration\TextRow::class;

						} else {
							$toUpdateRow['entity'] = Entities\Channels\Configuration\TextRow::class;
						}
					...
					case DevicesNode\Constants::DATA_TYPE_BOOLEAN:
						if ($isForDevice) {
							$toUpdateRow['entity'] = Entities\Devices\Configuration\BooleanRow::class;

						} else {
							$toUpdateRow['entity'] = Entities\Channels\Configuration\BooleanRow::class;
						}
					...
					case DevicesNode\Constants::DATA_TYPE_SELECT:
						if ($isForDevice) {
							$toUpdateRow['entity'] = Entities\Devices\Configuration\SelectRow::class;

						} else {
							$toUpdateRow['entity'] = Entities\Channels\Configuration\SelectRow::class;
						}
