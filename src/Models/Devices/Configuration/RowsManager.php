 ...
 * @author         Adam Kadlec <adam.kadlec@fastybird.com>
 *
 * @method onBeforeCreate(Entities\Devices\Configuration\IRow $entity, Utils\ArrayHash $values)
 * @method onAfterCreate(Entities\Devices\Configuration\IRow $entity)
 * @method onBeforeUpdate(Entities\Devices\Configuration\IRow $entity, Utils\ArrayHash $values)
 * @method onAfterUpdate(Entities\Devices\Configuration\IRow $entity, Entities\Devices\Configuration\IRow $oldEntity)
 * @method onBeforeDelete(Entities\Devices\Configuration\IRow $entity)
...
final class RowsManager implements IRowsManager
{
	...
	public function create(
		...
		// Service events
		$creator->beforeAction[] = function (Entities\Devices\Configuration\IRow $entity, Utils\ArrayHash $values): void {
			$this->onBeforeCreate($entity, $values);
		};

		$creator->afterAction[] = function (Entities\Devices\Configuration\IRow $entity): void {
	...
	public function update(
		...
		// Service events
		$updater->beforeAction[] = function (Entities\Devices\Configuration\IRow $entity, Utils\ArrayHash $values): void {
			$this->onBeforeUpdate($entity, $values);
		};

		$updater->afterAction[] = function (Entities\Devices\Configuration\IRow $entity) use ($oldEntity): void {
	...
	public function delete(
		...
		// Service events
		$deleter->beforeAction[] = function (Entities\Devices\Configuration\IRow $entity): void {
