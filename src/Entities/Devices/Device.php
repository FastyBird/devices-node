 ...
 *    "device"   = "FastyBird\DevicesNode\Entities\Devices\Device",
 *    "physical" = "FastyBird\DevicesNode\Entities\Devices\PhysicalDevice"
 * })
...
abstract class Device implements IDevice
{
	 ...
	 *
	 * @ORM\OneToMany(targetEntity="FastyBird\DevicesNode\Entities\Devices\Device", mappedBy="parent")
	 */
	protected $children;
	 ...
	 *
	 * @IPubDoctrine\Crud(is="writable")
	 * @ORM\OneToMany(targetEntity="FastyBird\DevicesNode\Entities\Channels\Channel", mappedBy="device", cascade={"persist", "remove"}, orphanRemoval=true)
	 */
	protected $channels;
