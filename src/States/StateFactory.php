...
final class StateFactory
{
	 ...
	 * @param NodeDatabaseEntities\IEntity|null $entity
	 *
	 * @return IState
	 */
	public static function create(
		...
		?NodeDatabaseEntities\IEntity $entity = null
	): IState {
		...
		try {
			...
			if ($constructor !== null) {
				$state = $rc->newInstanceArgs(self::autowireArguments($constructor, $document, $entity));
