...
final class PropertiesManagerTest extends BaseMockeryTestCase
{
	 ...
	 *
	 * @dataProvider ./../../../../../fixtures/Models/States/createDevicePropertyValue.php
	 */
	public function testCreateEntity(array $data, array $dbData, array $expected): void
	{
		...
		$manager = new Models\States\Devices\PropertiesManager($couchDbConnection, $dateFactory, $logger);

		$entityMock = Mockery::mock(Entities\Devices\Properties\Property::class);
		$entityMock
	 ...
	 * @param mixed[] $expected
	 *
	 * @dataProvider ./../../../../../fixtures/Models/States/updateDevicePropertyValue.php
	 */
	public function testUpdateEntity(array $data, array $originalData, array $expected): void
	{
		...
		$original = new States\Devices\Property($originalData['id'], $document, $entityMock);
